    ...
    <aside className="hidden md:flex flex-col w-64 bg-secondary border-r border-border h-screen sticky top-0">
      ...
      <div className="p-4 border-t border-border">
        <Link
          href="/settings"
          className={cn(
            "flex items-center gap-3 px-4 py-2.5 rounded-lg text-muted-foreground hover:bg-accent hover:text-accent-foreground",
        ...
        <button
          onClick={logout}
          className="flex items-center gap-3 w-full text-left px-4 py-2.5 mt-2 rounded-lg text-muted-foreground hover:bg-destructive/10 hover:text-destructive"
        >
